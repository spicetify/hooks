...
export type PlatformAutoGen = {
					...
					droppedEventsTracker: {
						...
						storageManager: {
							...
							storageAdapter: ReturnType<
								PlatformAutoGen["getAdManagers"]
							>["hpto"]["hptoApi"]["eventSender"]["droppedEventsTracker"]["storageManager"]["storage"][
								"adapter"
							];
							...
							_navigator: {
								...
								clipboard: {
									addEventListener: ReturnType<
										PlatformAutoGen["getAdManagers"]
									>["hpto"]["hptoApi"]["eventSender"]["transport"]["_connectionObserver"][
										"_navigator"
								...
								webkitTemporaryStorage: ReturnType<
									PlatformAutoGen["getAdManagers"]
								>["hpto"]["hptoApi"]["eventSender"]["transport"]["_connectionObserver"]["_navigator"][
	...
	getEventSender: () => ReturnType<
		PlatformAutoGen["getAdManagers"]
	>["hpto"]["hptoApi"]["eventSender"];
	getFacebookAPI: () => {
		_cosmos: ReturnType<
			PlatformAutoGen["getAudiobooksPremiumConsumptionCapObserverAPI"]
		>["_playerApi"]["_cosmos"];
	...
	getShuffleAPI: () => {
		...
		_userApi: {
			...
			_product_state_service: ReturnType<
				PlatformAutoGen["getOfflineAPI"]
			>["_events"]["_productState"];
			getEvents: () => any;
	...
	getUBILogger: () => {
		...
		ubiLogger: {
			...
			pageViewLogger: {
				...
				pageUriProvider: ReturnType<
					PlatformAutoGen["getUBILogger"]
				>["ubiLogger"]["pageUriProvider"];
